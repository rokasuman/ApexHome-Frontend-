...
export const landingPageStyles = {
  ...
  categoryHeader: "flex justify-center mb-10",

  categoryHeaderText: "max-w-xl text-center text-xl ",

  categoryTitle: "text-xl font-extrabold mb-3 max-sm:text-3xl",

  categoryDesc: "text-text-muted text-base",
  ...
  categoryName: "text-lg font-semibold mb-1",

  categoryCount: "text-sm text-text-muted",
  ...
  processCardTitle: "text-xl mb-4 font-bold text-text-main",
...
export const navbarStyles = {
  ...
  avatar:
    "w-10 h-10 rounded-full border-2 border-primary-light object-cover",

  logoutButton:
    "btn btn-outline py-1.5 px-4 rounded-xl font-semibold text-sm",

  mobileToggle:
    "lg:hidden cursor-pointer text-text-main flex items-center justify-center",

  // Background overlay
  backdrop: (isOpen) =>
    `fixed inset-0 bg-black/40 backdrop-blur-sm z-[2001] 
    transition-opacity duration-300 
    ${isOpen ? "opacity-100 visible" : "opacity-0 invisible"}`,

  // Mobile drawer
  drawer: (isOpen) =>
    `fixed top-0 left-0 w-[300px] h-screen bg-white z-[2002] 
    transition-transform duration-300 ease-in-out
    shadow-[10px_0_30px_rgba(0,0,0,0.1)] 
    border-r border-border flex flex-col p-6
  ...
  drawerNavLinks:
    "flex flex-col gap-6 flex-1 text-lg",
