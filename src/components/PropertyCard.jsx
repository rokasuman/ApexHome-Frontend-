...
import { propertyCardStyles as s } from "../assets/REAL-E-STATE/dummyStyles";
import { authUse } from "../../context/AuthContext";
import { Link, useNavigate } from "react-router-dom";
import { HiArrowsExpand, HiEye, HiLocationMarker, HiOutlineHome, HiOutlineUserGroup, HiShieldCheck } from "react-icons/hi";
      ...
      <Link to={`/property/${property._id}`} className={s.link}>
        <div className={s.imageSection}>
          ...
          <div className={s.topBadges}>
            ...
            {(!user || user.role === "buyer") && (
              <button onClick={handleOnWishList} className={s.wishlistButton}>
                {isWishlisted ? "❤️" : "🤍"}
              </button>
            )}
          </div>
        ...
        <div className={s.content}>
          ...
          <div className={s.specsGrid}>
            {property.propertyType?.toLowerCase() === "commerical" ? (
              <>
